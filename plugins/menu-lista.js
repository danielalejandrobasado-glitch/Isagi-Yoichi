...
let handler = async (m, { conn, prefijo, text, args, command }) => {
    ...
    let txt = `╭࣭࣭࣭࣭࣭࣭ٜ۫┄̸࣭࣭࣭࣭࣭ٜ۫🎵⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬💙⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬🎵︎︎︎̸┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫╮\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐇𝐨𝐥𝐚: ${name}🎀\n`  
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐓𝐢𝐞𝐦𝐩𝐨 𝐀𝐜𝐭𝐢𝐯𝐨\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬${uptime}🎵\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐕𝐨𝐜𝐚𝐥𝐨𝐢𝐝 𝐅𝐚𝐧𝐬\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬${rtotalreg}🎤\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐓𝐨𝐭𝐚𝐥 𝐝𝐞 𝐔𝐬𝐮𝐚𝐫𝐢𝐨𝐬\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬${rtotal}💙\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐕𝐞𝐫𝐬𝐢𝐨́𝐧 𝐌𝐢𝐤𝐮`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬39.01❄️\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐒𝐞𝐥𝐞𝐜𝐜𝐢𝐨𝐧𝐚 𝐭𝐮 𝐜𝐚𝐧𝐜𝐢𝐨́𝐧 𝐟𝐚𝐯𝐨𝐫𝐢𝐭𝐚\n`
        txt += `⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪🎧۪۬𝐃𝐢𝐬𝐟𝐫𝐮𝐭𝐚 𝐌𝐢𝐤𝐮-𝐁𝐨𝐭 (๑˃̵　ᴗ　˂̵)و\n`
        txt += `╰┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫🎵⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬💙⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬🎵︎︎︎̸┄̸࣭࣭࣭࣭࣭ٜ۫╯`;

    let listSections = []
listSections.push({
title: `✎ SELECCIÓNA LO QUE NECESITES`, highlight_label: `Popular Miku`,
rows: [
{
title: "│💮│ᴄʀᴇᴀᴅᴏʀ ᴅᴇʟ ʙᴏᴛ", 
description: "ɴᴜᴍᴇʀᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇ DEPOOL",
id: `${prefijo}owner`,
},
{
title: "│💙│ɢʀᴜᴘᴏs ᴏғᴄ ᴅᴇʟ ʙᴏᴛ", 
description: "ᴏʙᴛᴇɴ ʟᴀ ʟɪsᴛᴀ ᴅᴇ ʟᴏs ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇ Hatsune Miku",
id: `${prefijo}grupos`,
},
{
...
{
title: "│❔│ɪɴғᴏ ᴅᴇʟ ʙᴏᴛ", 
description: "ᴏʙᴛᴇɴ ʟᴀ ɪɴғᴏʀᴍᴀᴄɪᴏɴ ᴅᴇ Hatsune-Miku",
id: `${prefijo}infobot`,
},
{
...
{
title: 'Mᴇɴᴜs ᴅᴇ Hatsune Miku', highlight_label: "Popular",
rows: [
{
title: "│💙│ᴍᴇɴᴜ ᴄᴏᴍᴘʟᴇᴛᴏ", 
...
let vid = "https://foodbizbrasil.com/wp-content/uploads/2025/02/mcdonalds-japao-parceria-hatsune-miku.png"
let img = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbltSZfkRat6b0agEC0_nz3Z75cJtimp2ic_xzwhNqtLEo5i5Rq8M4guhuEoKDqocGups"
