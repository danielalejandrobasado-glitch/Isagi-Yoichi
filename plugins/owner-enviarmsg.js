...
const idgp = "120363315369913363@newsletter"; 
...
var handler = async (m, { conn, text }) => {
    ...
    try {
        ...
        if (isMedia && quoted.mtype === 'imageMessage') {
            ...
            mediax = await quoted.download?.();
            await conn.sendMessage(idgroup, { audio: mediax, mimetype: 'audio/mp4', fileName: `miku.mp3` }, { quoted: null });
