...
// Mover la inicialización después de las configuraciones globales
...
// Inicializar prototipos después de configurar las funciones globales
try {
  protoType()
  serialize()
} catch (error) {
...
// Función para asegurar que los directorios necesarios existan
function ensureDirectoriesExist() {
const dirs = ['./tmp', './MikuSession', './db']
dirs.forEach(dir => {
...
// Solo usar el directorio tmp local, no MikuJadiBot
tmp = [tmpDir]
